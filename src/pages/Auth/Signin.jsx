    ...
    <div className="flex flex-col">
      ...
      <div className="flex justify-center my-4">
        <form className="shadow-lg w-3/4 md:w-2/3 lg:w-1/2 rounded px-8 pt-6 pb-8 mb-24">
          <SocialButton onClick={signInWithGoogle} bgColor="bg-red-400" hoverColor="hover:bg-red-300" socialIcon={google} socialPlatform="Google"/>
          <SocialButton onClick={signInWithFacebook} bgColor="bg-blue-400" hoverColor="hover:bg-blue-300" socialIcon={facebook} socialPlatform="Facebook"/>
